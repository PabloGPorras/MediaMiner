...
class NotificationWidget(QWidget):
    def __init__(self, parent=None):
        ...
        self.setStyleSheet("background-color: #ffcccc; border: 1px solid red; padding: 10px;")
    ...
    def add_error(self, error_message):
        ...
        close_button.setStyleSheet("margin-top: 5px;")
        close_button.clicked.connect(lambda: self._remove_error(error_label, close_button))
        self.layout.addWidget(close_button)

    def _remove_error(self, label, button):
