...
class ModelForm(QWidget):
    def __init__(self, model_class, instance=None, related_form=None, included_columns=None, excluded_columns=None,
        ...
        self.fields = {}
        self.related_form = related_form  # This is an instance of RelatedModelForm for managing related entries
    ...
    def set_main_layout(self):
        ...
        # Add the related form to the layout if it is provided
